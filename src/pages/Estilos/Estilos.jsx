    ...
    <div>
        ...
        <div className='navbar-toggler pe-3'>
          <button className="btn btn-primary rounded-pill" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-controls="collapseExample" aria-expanded="false" aria-label="Toggle navigation">
            <IconSet imageUrl={'/icons/icon-menu-outline.svg'} />
          </button>
        </div>
          ...
          <div className="d-flex align-itens-center">
            ...
            <div className='actions'>
              <button className='btn btn-light'>
                <IconSet imageUrl={'/icons/icon-brand-messenger.svg'} />
              </button>
              <button className='btn btn-light'>
                <IconSet imageUrl={'/icons/icon-bell.svg'} />
              </button>
      ...
      <div className='container-fluid'>
        ...
        <div className='mb-5'>
          ...
          <button className="btn btn-primary me-2"><IconSet styleClass={'me-2'} imageUrl={'/icons/icon-home-stats.svg'} />Button Primary</button>
          <button className="btn btn-secondary me-2"><IconSet styleClass={'me-2'} imageUrl={'/icons/icon-home-stats.svg'} />Button Secondary</button>
          <button className="btn btn-light me-2"><IconSet styleClass={'me-2'} imageUrl={'/icons/icon-home-stats.svg'} />Button Light</button>
          <button className="btn btn-link me-2"><IconSet styleClass={'me-2'} imageUrl={'/icons/icon-home-stats.svg'} />Button Link</button>
          <a href="#"><IconSet styleClass={'me-2'} imageUrl={'/icons/icon-home-stats.svg'} />link</a>
        </div>
        <div className='mb-5'>
          <h3>Forms</h3>
        ...
        <div className='mb-5'>
          ...
          <div className="btn-group">
            <button type="button" className="btn btn-danger dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
              <IconSet styleClass={'me-2'} imageUrl={'/icons/icon-home-stats.svg'}></IconSet>Dropdown Menu
            </button>
